...
EMAIL_ACTIVITIES = [
    # ── Calendar events (Mon-Thu, extracted from Gmail invitations) ───
    # Monday Apr 6
    {"source": "calendar", "source_id": "cal-rna-leads-sync-0406", "title": "RNA Leads Sync weekly", "summary": "Weekly leads sync with Sid Kumar, Jane Guthrie, Nicole, Stephen, Tiffany, Sahana, Eddie, Alex, Nakib", "duration_minutes": 30, "occurred_at": "2026-04-06T10:00:00", "participants": ["Sid Kumar", "Jane Guthrie", "Nicole Jayne", "Stephen Yu", "Tiffany Huang", "Sahana Srivatsan", "Nakib Khandaker"]},

    # Tuesday Apr 7
    {"source": "calendar", "source_id": "cal-l2c-office-hours-0407", "title": "L2C Office Hours", "summary": "L2C office hours with Jennifer Dessin, Kylie Tuosto, Jing Wang, Saikat, Srilekha — two-way sync for quad leads", "duration_minutes": 55, "occurred_at": "2026-04-07T11:05:00", "participants": ["Jennifer Dessin", "Kylie Tuosto", "Jing Wang", "Saikat Mukherjee", "Srilekha Chandrashekar"]},
    {"source": "calendar", "source_id": "cal-daily-mpr-sync-0407", "title": "Daily Sync: Marketing Performance Reporting via QB BI Platform", "summary": "Daily sync for 5/11 launch goal — status from Design, Prod, Eng", "duration_minutes": 15, "occurred_at": "2026-04-07T11:00:00", "participants": ["Nakib Khandaker", "Lauren Colwell", "Sid Kumar", "Nicole Jayne", "Stephen Yu", "Eddie Shrake"]},

    # Wednesday Apr 8
    # (no additional meetings found for Wed)

    # Thursday Apr 9
    {"source": "calendar", "source_id": "cal-michael-intro-l2c-0409", "title": "Deepak / Michael - Intro & L2C", "summary": "1:1 with Michael Walton to discuss L2C opportunity, CRM platform role", "duration_minutes": 30, "occurred_at": "2026-04-09T10:00:00", "participants": ["Michael Walton"]},
    {"source": "calendar", "source_id": "cal-daily-mpr-sync-0409", "title": "Daily Sync: Marketing Performance Reporting via QB BI Platform", "summary": "Daily sync for 5/11 launch goal", "duration_minutes": 15, "occurred_at": "2026-04-09T12:30:00", "participants": ["Nakib Khandaker", "Lauren Colwell", "Sid Kumar", "Nicole Jayne", "Stephen Yu"]},
    {"source": "calendar", "source_id": "cal-marketing-deep-dive-0409", "title": "Kick off deeper dive with Marketing teams on the MC side", "summary": "Deep dive on MC marketing with Shani Boston, Kylie Tuosto, Jing Wang, Dan Damkoehler, Bret Wheeless", "duration_minutes": 60, "occurred_at": "2026-04-09T12:00:00", "participants": ["Shani Boston", "Kylie Tuosto", "Jing Wang", "Dan Damkoehler", "Bret Wheeless", "Srilekha Chandrashekar"]},
    {"source": "calendar", "source_id": "cal-deepak-nakib-0409", "title": "Deepak / Nakib 1:1", "summary": "Quick 1:1 with Nakib Khandaker", "duration_minutes": 15, "occurred_at": "2026-04-09T12:45:00", "participants": ["Nakib Khandaker"]},

    # Friday Apr 10 (report day — still counts for meeting hours)
    ...
    {"source": "calendar", "source_id": "cal-zoom-stephen", "title": "Zoom Meeting with Stephen Yu", "summary": "1:1 meeting with Stephen Yu", "duration_minutes": 30, "occurred_at": "2026-04-10T13:20:00", "participants": ["Stephen Yu"]},
    {"source": "calendar", "source_id": "cal-l2c-deep-dive", "title": "Deep Dive Session on Target L2C Customers", "summary": "Deep dive on L2C target customers with Diana Williams, Nathan Bullock, Jack Tam, Matt Idema, Michael Walton", "duration_minutes": 60, "occurred_at": "2026-04-10T14:39:00", "participants": ["Diana Williams", "Nathan Bullock", "Jack Tam", "Matt Idema", "Michael Walton"]},
    {"source": "calendar", "source_id": "cal-mc-program-review", "title": "Weekly MC Program Review — MC Leadership Execution Tracker", "summary": "MC program review with Jack Tam, Nathan Bullock, Shani Boston", "duration_minutes": 60, "occurred_at": "2026-04-10T15:45:00", "participants": ["Jack Tam", "Nathan Bullock", "Shani Boston", "Saikat Mukherjee"]},
